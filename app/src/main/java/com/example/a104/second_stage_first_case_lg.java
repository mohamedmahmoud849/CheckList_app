...
public class second_stage_first_case_lg extends Fragment {

    String title1;
    String title2;
    String [] lg_cases ;

    public second_stage_first_case_lg(String string1, String string2){
        title1 = string1;
        title2 = string2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_second_stage_first_case_lg, container, false);
        ...
        lg_cases = getResources().getStringArray(R.array.lg_case1_cases);
        ...
        n.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setFragment(new last_page("lg",title2,lg_cases[0]));
        ...
        n2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setFragment(new last_page("lg",title2,lg_cases[1]));
        ...
        n3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setFragment(new last_page("lg",title2,lg_cases[2]));
